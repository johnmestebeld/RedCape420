...
Bullet.prototype.fire = function (startX, startY) {
	var soundEffect = new Audio("audio/shooting1.mp3");
	soundEffect.play();
	this.drawX = startX;
	this.drawY = startY;
...
function Enemy() {
	...
	this.randomMoveTime = randomRange(2000, 8000);
	this.speed = 1;
	var that = this;
...
Enemy.prototype.die = function () {
	var soundEffect = new Audio("audio/hurt.mp3");
	soundEffect.play();
...
function collision(a, b) { // takes two objects enemy and bullet 
